...
def task1(s):
    ...
    s = input()
comma_index = s.find(',')
first_sub = s[:comma_index]
second_sub = s[comma_index + 1:]
print(len(first_sub)) > len(second_sub)
print(first_sub == second_sub)
print(second_sub in first_sub)
...
def task6(s):
    ...
    s = input()
s = input()
result = (s.lower() == s.lower()[::-1]) and (s.count(' ') == 0)
print(result)
